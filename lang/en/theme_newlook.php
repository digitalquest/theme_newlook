 ...
 */
$string['example'] = 'YUI EXAMPLE';

$string['pluginname'] = 'New Look';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';

$string['choosereadme'] = '
<div class="clearfix"><div class="theme_screenshot"><h2>New Wave</h2>
...
$string['academicyear'] = 'Current academic year';
$string['academicyeardesc'] = 'This define the current academic year. Courses are not in the current academic year will diplay a warning message to users.';
...
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['academicyearwarning'] = 'Academic year warning';
$string['academicyearwarningdesc'] = 'If ticked, a warning message is diplayed -on course pages- if Moodle thinks a course does not belong to the current academic year';
